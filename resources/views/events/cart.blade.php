    ...
    <div class="container-fluid">
        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('basket.update' , $item->id)}}" method="post" class="form-inline">
                                            ...
                                            <button type="submit" class="btn btn-outline-primary btn-sm">@lang('payment.update')</button>
                                        </form>
                                    </td>
            ...
            <div class="col-md-4">
                ...
                <a href="#" class="btn mt-4  btn-danger btn-lg w-100 d-block">@lang('payment.confirm and continue')</a>
            </div>
        </div>
    </div>
    @endif
